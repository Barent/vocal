...
Router.map(function () {
	...
	this.route("contacts.details", {path: "/contacts/details/:Id", controller: "ContactsDetailsController"});
	this.route("contacts.edit", {path: "/contacts/edit/:Id", controller: "ContactsEditController"});
	this.route("events", {path: "/events", controller: "EventsController"});
	this.route("events.insert", {path: "/events/insert", controller: "EventsInsertController"});
	this.route("events.details", {path: "/events/details/:Id", controller: "EventsDetailsController"});
	this.route("events.edit", {path: "/events/edit/:Id", controller: "EventsEditController"});
